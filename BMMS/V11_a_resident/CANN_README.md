...
- [提交包：R14控制与三个独立候选](BMMS/BMMS_V11_R17_R18_R19_提交包.zip) / [使用说明](BMMS/BMMS_V11_R17_R18_R19/README.md)
- [当前审计](BMMS/BatchMatmulMaxSum_当前审计报告_2026-09-26.md)
- [用户计划快照](BMMS/V11_a_resident/INPUT_PLAN.md) / [实现设计](BMMS/V11_a_resident/DESIGN.md)
- [CPU检查](BMMS/V11_a_resident/CHECKS.json) / [上轮交付快照](BMMS/audit_current/AUDIT_R15_R16_DELIVERY.md)
